import { LayoutDashboard, User, FileText, Activity, Briefcase, Settings, LogOut, BarChart3, X } from 'lucide-react';
...
export default function Sidebar({ activeItem, onItemClick, onLogout, isOpen = false, onClose }: SidebarProps) {
    ...
    <>
      ...
      >
        <div className="h-14 px-5 flex items-center justify-between border-b border-slate-200">
          <span className="text-sm font-semibold text-primary-900 tracking-tight">FPMS</span>
          <button
            type="button"
            onClick={onClose}
